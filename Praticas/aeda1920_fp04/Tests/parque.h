...
public:
    ...
    bool operator<(const InfoCartao c);
};
...
public:
    ...
    friend ostream & operator<<(std::ostream &out, ClienteNaoExistente &cne);
};
...
public:
    ...
    friend ostream & operator<<(std::ostream &out, PosicaoNaoExistente &pne);
};
